        ...
        <div className="flex flex-col justify-center flex-1">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-center">
            ...
            <div className="flex flex-col justify-center">
              <h1 className="mb-3 md:mb-4 text-3xl md:text-4xl lg:text-5xl xl:text-7xl font-bold tracking-tight text-gray-900">
                Your link-in-bio,
                <br />
                now with a brain
              </h1>
              ...
              <div className="w-[470px] mt-4 max-lg:w-[400px] max-sm:mt-6 max-sm:w-[98%]">
