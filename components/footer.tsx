...
export default function Footer() {
  return (
    <footer id="contact" className="relative text-black overflow-hidden bg-white">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 py-8 md:py-16">
        ...
        <div className="flex flex-wrap gap-6 md:gap-8">
          <Link href="#" className="footer-link opacity-80 hover:opacity-100 transition-opacity">
            Features
          </Link>
          <Link href="#" className="footer-link opacity-80 hover:opacity-100 transition-opacity">
            Help Center
