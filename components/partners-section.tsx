  ...
  return (
    <section className="py-12 md:pt-16 relative">
      <div className="text-center mb-8">
        <h2 className="text-2xl md:text-6xl font-medium text-gray-900 tracking-tight">Loved by top creators</h2>
      </div>
      ...
      <div className="w-full relative overflow-hidden">
        ...
        <Marquee pauseOnHover={true}>
          {partnerLogos.map((logo, index) => (
            <div key={index} className="relative h-full w-fit mx-1 flex items-center justify-start group">
