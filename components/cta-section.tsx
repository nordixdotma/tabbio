      ...
      <div className="max-w-4xl mx-auto px-4 md:px-6 text-center">
        ...
        <div className="relative w-full max-w-lg mx-auto mt-10">
          ...
          <input
            ...
            className="bg-[#f4f4f4] text-gray-900 placeholder-gray-400 focus:border-gray-300 w-full rounded-full h-16 font-normal text-lg md:text-2xl pl-28 pr-40 focus:outline-none focus:ring-0"
            id="slug"
            placeholder="name"
          />
          <button
